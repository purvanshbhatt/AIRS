        ...
        <div className="space-y-12">
            ...
            <section>
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200">
                    ...
                    <h3 className="font-medium text-gray-900 mb-3">Mapped Tactics:</h3>
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-2 mb-6">
                        {[
                            ...
                            <div key={tactic} className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200">
                    ...
                    <div className="space-y-4 mb-6">
                        <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                            <h4 className="font-medium text-green-800 mb-1">IG1 - Basic Cyber Hygiene</h4>
                            <p className="text-sm text-green-700">Essential controls for all organizations. Minimum baseline for security.</p>
                        </div>
                        <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                            <h4 className="font-medium text-yellow-800 mb-1">IG2 - Enhanced Controls</h4>
                            <p className="text-sm text-yellow-700">For organizations handling sensitive data. Builds on IG1.</p>
                        </div>
                        <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                            <h4 className="font-medium text-red-800 mb-1">IG3 - Advanced Controls</h4>
                            <p className="text-sm text-red-700">For high-value targets facing sophisticated adversaries.</p>
                        </div>
                    </div>

                    <h3 className="font-medium text-gray-900 mb-3">Key Control Areas:</h3>
                        ...
                        {[
                            ...
                            >
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="text-xs font-mono text-purple-600">{item.id}</span>
                                    {item.relevant && (
