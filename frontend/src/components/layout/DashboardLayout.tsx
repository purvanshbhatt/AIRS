        ...
        <div className="p-4 border-t border-slate-200  shrink-0">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-50 ">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-900  truncate">{displayEmail}</p>
            </div>
          </div>
          ...
          {(user || isConfigured) && (
            <button
              ...
              className="mt-2 w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-900  hover:text-gray-900  hover:bg-slate-100  rounded-lg transition-colors"
            >
